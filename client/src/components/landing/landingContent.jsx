...
function LandingContent() {
    return (
        <div className='my-10 flex flex-col items-center font-mont'>
            <div className='flex flex-col-reverse lg:flex-row gap-10 w-[95%] lg:w-[80%] items-center lg:items-start justify-center'>
                <div className='flex flex-col gap-5'>
                    <h1 className='text-[#1A5D1A] mb-3 font-bold text-2xl lg:text-4xl lg:-ml-5' >Education and Training</h1>
                ...
                <img src={img1} alt="" className='object-contain w-[60%] lg:w-[50%]'/>
            </div>
            <div className='w-[80%] my-10 lg:my-12 border-gray-300 border-0 border-b-[2px] h-1'></div>
            <div className='flex flex-col lg:flex-row items-center lg:items-start gap-10 w-[95%] lg:w-[80%] justify-center'>
                <img src={img2} alt="" className='w-[60%] lg:w-[40%] object-contain' />
                <div className='flex flex-col gap-1 lg:gap-3'>
                    <h1 className='text-[#1A5D1A]  font-bold text-2xl lg:text-4xl lg:-ml-5' >Tourism and Service</h1>
