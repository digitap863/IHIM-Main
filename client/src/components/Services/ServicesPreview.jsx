...
function ServicesPreview() {
  return (
    <div className='mx-40 flex justify-center gap-10 py-20 font-mont'>
        <div className='border rounded-2xl shadow-lg pt-10 pb-24 flex flex-col items-center relative gap-7 w-[40%]'>
            <img src={services1} alt="" className='w-[70%]'/>
            <h1 className='text-[#1A5D1A] font-[600] text-3xl'>Education and Training</h1>
        ...
        <div className='border rounded-2xl shadow-lg pt-10 pb-24 flex flex-col items-center relative gap-7 w-[40%]'>
            ...
            <h1 className='text-[#1A5D1A] font-[600] text-3xl'>Tourism and Services</h1>
