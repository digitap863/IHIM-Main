       ...
       <h1 className=' mb-5 font-bold text-4xl lg:text-5xl text-[#1A5D1A] text-center'>MEET THE MAN BEHIND IHA</h1> 
        <div className='flex mx-5 lg:mx-40 items-center flex-col-reverse lg:flex-row gap-28 mt-16  justify-center'>
            <div className='lg:w-[60%]'>
                ...
                <p className='leading-loose font-[400] text-center lg:text-left'>Santhosh Kumar. A, is the visionary behind this International Human Resource Improvement Movement. He is the third generation descendant of Kairali Vidheyan Shri Rama Varma Appan Thampuran. The architect of the Cultural Capital of Kerala, Shri. Thampuran has trained and guided many to reach the peaks of recognition. The career and other history of Santhosh clearly show that he is continuing the still prevailing visions & missions of Shri. Appan Thampuran. He is part of the governing body of the Appan Thapuran study and research, officially named Appan Thampuran Padana Geveshna Samathi <br />
