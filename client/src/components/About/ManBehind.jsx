...
function ManBehind() {
  return (
    <div className=' font-mont relative bg-slate-100 py-24 overflow-hidden'>
        <img src={leaf} alt="" className='absolute w-[10%] -left-6 bottom-10 -rotate-90'/>
        <img src={leaf} alt="" className='absolute w-[10%] -right-7 top-9 rotate-90'/>
