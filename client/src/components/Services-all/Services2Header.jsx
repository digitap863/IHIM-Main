...
function Services2Header() {
    return (
        <div className='h-[100vh] relative overflow-hidden font-mont flex pt-20 lg:pt-0 items-center flex-col gap-10 -mb-[125%] md:-mb-[90%] lg:-mb-[20%] bg-[#fffffb]'>
            <Navbar />
            ...
            <p className='text-green-900 font-semibold text-lg lg:text-xl md:w-[60%] lg:w-[35%] text-center'>Building the right attitude to personal growth
