...
function SendMsg() {
    return (
        <div className='w-full flex justify-center font-mont relative overflow-hidden'>
            ...
            <div className='flex flex-col-reverse md:flex-row border-[1px] border-gray-300 rounded-3xl shadow-lg items-center mt-16 gap-10 lg:gap-40 w-[90%] lg:w-[80%]'>
                <div className='md:w-[60%] lg:w-[50%] xl:w-[30%]'>
                    <iframe className='w-full flex justify-center lg:w-[120%] h-[40rem] md:rounded-l-3xl' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d251482.7184990422!2d76.13612104751219!3d9.98233153162407!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b080d514abec6bf%3A0xbd582caa5844192!2sKochi%2C%20Kerala!5e0!3m2!1sen!2sin!4v1696659433524!5m2!1sen!2sin" width="600" height="450" allowfullscreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                </div>
                <div className='w-[85%] lg:w-[50%] flex flex-wrap justify-center lg:justify-start gap-7'>
                    <h1 className='text-2xl  mt-5 lg:mt-0 lg:text-4xl xl:text-5xl font-bold text-[#1A5D1A] lg:w-[50%]'>Send Us a Message</h1>
