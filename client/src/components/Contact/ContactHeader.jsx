...
function ContactHeader({ title, pageTitle }) {
  return (
    <div className='h-screen bg-gradient-to-br from-[#258425] to-[#85A231] relative overflow-hidden font-mont flex items-center px-20'>
      ...
      <div className='ml-20 z-10 relative flex flex-col justify-center h-full w-full'>
        <h5 className='text-green-900 font-semibold text-xl'>{pageTitle}</h5>
        <h1 className='text-white  text-7xl font-extrabold mt-3 w-[90%]'>{title}</h1>
        <div className='flex text-2xl gap-4 text-white mt-10'>
        ...
        <div className='flex justify-center gap-10 mt-20'>
          <div className='bg-white flex pl-6 w-1/3 gap-7 rounded-xl py-10'>
            <div className='bg-[#1A5D1A] text-4xl text-white rounded-full flex items-center justify-center w-20 h-20'>
              <IoIosMail />
            </div>
