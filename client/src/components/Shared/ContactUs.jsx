...
function ContactUs() {
    return (
        <div className='relative'>
            ...
            <div className='mx-4'>
                <div className='bg-[#E0F0D5] my-16 rounded-2xl lg:rounded-[3rem] shadow-lg py-5 lg:py-16 md:px-6 lg:px-20 flex flex-col-reverse md:flex-row items-center justify-center  lg:mx20 gap-24 font-mont relative max-w-screen-2xl mx-auto'>
